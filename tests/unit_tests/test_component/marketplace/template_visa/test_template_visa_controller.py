...
from mamba.marketplace.components.template.visa_controller import VisaControllerComponent
from mamba.core.exceptions import ComponentConfigException
from mamba.core.msg import Empty, ServiceRequest, ServiceResponse, ParameterType

component_path = os.path.join('marketplace', 'components', 'template',
                              'visa_controller')
...
class TestClass:
    ...
    def test_visa_sim_local_from_project_folder(self):
        ...
        component = VisaControllerComponent(
            self.context,
    ...
    def test_w_wrong_custom_context(self):
        ...
        with pytest.raises(ComponentConfigException) as excinfo:
            VisaControllerComponent(self.context,
                                    local_config={
                                        'parameters': 'wrong'
                                    }).initialize()
    ...
    def test_io_service_request_observer(self):
        ...
        self.context.rx['io_service_request'].on_next(
            ServiceRequest(provider='visa_controller_template',
                           id='NOT_EXISTING',
                           type='any',
                           args=[]))
        ...
        assert dummy_test_class.func_1_last_value.id == 'idn'
        assert dummy_test_class.func_1_last_value.type == ParameterType.get
        assert dummy_test_class.func_1_last_value.value == 'VISA_SIM'
