...
MOCK_FILE = os.path.join('marketplace', 'components', 'digitizer',
                         'keysight_m8131a', 'visa_sim.yml')
...
class TestClass:
    ...
    def test_dialogues(self):
        assert self.visa_inst.query(
            '*IDN?') == 'Keysight Technologies, M8131A, SN XXXX'
    ...
    def test_properties(self):
        ...
        assert self.visa_inst.query(
            ':DIAG:SYNC:TSTamp:VALue? CHAN1') == '123456'
