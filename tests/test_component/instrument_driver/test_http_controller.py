...
from mamba.component.instrument_driver.http.http_controller import HttpController
from mamba.core.exceptions import ComponentConfigException
from mamba.core.msg import Empty, ServiceRequest, ServiceResponse, ParameterType

component_path = os.path.join('component', 'instrument_driver', 'http',
                              'http_controller')
...
class TestClass:
    ...
    def test_w_default_context_component_creation(self):
        ...
        component = HttpController(self.context)
        ...
        assert component._instrument.port == 5000
    ...
    def test_w_wrong_custom_context(self):
        ...
        with pytest.raises(ComponentConfigException) as excinfo:
            HttpController(self.context, local_config={
                'parameters': 'wrong'
            }).initialize()
    ...
    def test_io_service_request_observer(self):
        ...
        # Start Mock
        mock = FlaskServerMock(self.context)
        mock.initialize()
        ...
        self.context.rx['io_service_request'].on_next(
            ServiceRequest(provider='http_controller',
                           id='NOT_EXISTING',
                           type='any',
                           args=[]))
        ...
        assert dummy_test_class.func_1_last_value.type == ParameterType.get
        assert dummy_test_class.func_1_last_value.value == 'Mamba Framework,HTTP Flask Mock,1.0'
        ...
        assert component._shared_memory == {
            'raw_query': 'Mamba Framework,HTTP Flask Mock,1.0'
        }
    ...
    def test_multi_command_multi_input_parameter(self):
        ...
        assert component._shared_memory == {'new_param': None, 'raw_query': ''}
